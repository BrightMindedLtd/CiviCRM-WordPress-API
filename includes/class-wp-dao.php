...
class CRM_WordPress_DAO extends CRM_Core_DAO
{
	...
	{
		return (Civi::$statics[static::$className]['fields'] ??= static::loadSchemaFields());
	}
	...
	private static function loadSchemaFields(): array
	{
		...
		$baoName = CRM_Core_DAO_AllCoreTables::getBAOClassName(static::$className);
		...
		CRM_Core_DAO_AllCoreTables::invoke(static::$className, 'fields_callback', $fields);
		return $fields;
	}
	...
	public static function indices(bool $localize = TRUE): array
	{
		...
		return ($localize && $indices) ? CRM_Core_DAO_AllCoreTables::multilingualize(static::$className, $indices) : $indices;
	}

	private static function getEntityDefinition(): array
	{
		$entityName = CRM_Core_DAO_AllCoreTables::getEntityNameForClass(static::$className);
